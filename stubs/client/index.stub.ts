...
export interface IClientEvent {
  ...
  windowResolutionChange: (
    oldResolution: shared.Vector2,
    newResolution: shared.Vector2
  ) => void;
...
export function emitServerUnreliable<
  K extends keyof shared.ICustomClientServerEvent
>(eventName: K, ...args: Parameters<shared.ICustomClientServerEvent[K]>): void;
...
export function onRpc<K extends keyof shared.ICustomServerClientRpc>(
  ...
  listener: (
    ...
    | ReturnType<shared.ICustomServerClientRpc[K]>
): void;
...
export function isTextureExistInArchetype(
  modelHash: number,
...
export function on<K extends keyof IClientEvent | keyof ICustomEmitEvent>(
  eventName: K,
  listener: (
    ...args: shared.EventParameters<IClientEvent, ICustomEmitEvent, K>
  ) => void
): void;
...
export function setRotationVelocity(
  scriptID: number,
  x: number,
  y: number,
  z: number
...
export function setWeatherCycle(
  weathers: number[],
  multipliers: number[]
): void;
/**
...
export function screenToWorld(
  xOrValue: number | shared.IVector2,
  y?: number
): shared.Vector3 {
  // TODO Implement
  return null;
...
export function requestAnimSet(
  animSet: string,
  timeout?: number
): Promise<void>;
export function requestAnimSet(
...
export function registerPedheadshotBase64(
  ped: Player | number
): Promise<string>;
/**
...
export function registerPedheadshot3Base64(
  ped: Player | number
): Promise<string>;
/**
...
export function registerPedheadshotTransparentBase64(
  ped: Player | number
): Promise<string>;
/**
...
export function getClosestObject(options?: {
  pos?: shared.IVector3;
  range?: number;
}): Object | null;
/**
...
export function getClosestWorldObject(options?: {
  pos?: shared.IVector3;
  range?: number;
}): Object | null;
/**
...
export function getClosestVirtualEntity(options?: {
  pos?: shared.IVector3;
  range?: number;
}): VirtualEntity | null;
/**
...
export function getLocalMeta<K extends string>(
  key: Exclude<K, keyof shared.ICustomPlayerLocalMeta>
): unknown;
export function getLocalMeta<
  K extends shared.ExtractStringKeys<shared.ICustomPlayerLocalMeta>
>(key: K): shared.ICustomPlayerLocalMeta[K] | undefined;
...
export class BaseObject extends shared.BaseObject {
  ...
  public static getByRemoteID(
    type: shared.BaseObjectType,
    id: number
  ): BaseObject {
    // TODO implement
    return null;
  ...
  public deleteMeta<K extends shared.ExtractStringKeys<ICustomBaseObjectMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  ...
  public hasMeta<K extends shared.ExtractStringKeys<ICustomBaseObjectMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public getMeta<
    K extends string | shared.ExtractStringKeys<ICustomBaseObjectMeta>,
    V extends any
  ...
  public setMeta<K extends string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomBaseObjectMeta, K, unknown, void>
  ): void;
  ...
  public setMeta<V extends any, K extends string = string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomBaseObjectMeta, K, V, void>
  ): void;
  ...
  >(
    ...
    value:
      ...
      | ICustomBaseObjectMeta[K]
      | shared.InterfaceValueByKey<ICustomBaseObjectMeta, K, V, void>
  ): void {
    // TODO implement
  }
}
...
export class VirtualEntity extends WorldObject {
  ...
  >(key: K): shared.ICustomVirtualEntityStreamSyncedMeta[K];
  /** @deprecated See {@link "alt-shared".ICustomVirtualEntityStreamSyncedMeta} */

  public getStreamSyncedMeta<
    K extends
      | string
      | shared.ExtractStringKeys<shared.ICustomVirtualEntityStreamSyncedMeta>,
    V extends any
  >(
...
export class Audio extends BaseObject {
  ...
  public deleteMeta<K extends shared.ExtractStringKeys<ICustomAudioMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  ...
  public hasMeta<K extends shared.ExtractStringKeys<ICustomAudioMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public getMeta<K extends string>(key: Exclude<K, never>): unknown;
  public getMeta<K extends shared.ExtractStringKeys<ICustomAudioMeta>>(
    key: K
  ): ICustomAudioMeta[K];
  /** @deprecated See {@link ICustomAudioMeta} */

  public getMeta<
    K extends string | shared.ExtractStringKeys<ICustomAudioMeta>,
    V extends any
  >(key: Exclude<K, never> | string): unknown | ICustomAudioMeta[K] | V {
    // TODO implement
    return null;
  }
  public setMeta<K extends string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomAudioMeta, K, unknown, void>
  ): void;
  public setMeta<K extends shared.ExtractStringKeys<ICustomAudioMeta>>(
    key: K,
  ...
  public setMeta<V extends any, K extends string = string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomAudioMeta, K, V, void>
  ): void;
  ...
  >(
    ...
    value:
      | shared.InterfaceValueByKey<ICustomAudioMeta, K, unknown, void>
      | ICustomAudioMeta[K]
      | shared.InterfaceValueByKey<ICustomAudioMeta, K, V, void>
  ): void {
    // TODO implement
  }
}
...
export class Checkpoint extends WorldObject {
  ...
  public deleteMeta<K extends shared.ExtractStringKeys<ICustomCheckpointMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  ...
  public hasMeta<K extends shared.ExtractStringKeys<ICustomCheckpointMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public getMeta<
    K extends string | shared.ExtractStringKeys<ICustomCheckpointMeta>,
    V extends any
  >(key: Exclude<K, never> | string): unknown | ICustomCheckpointMeta[K] | V {
    // TODO implement
    return null;
  }
  public setMeta<K extends string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomCheckpointMeta, K, unknown, void>
  ): void;
  ...
  public setMeta<V extends any, K extends string = string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomCheckpointMeta, K, V, void>
  ): void;
  ...
  >(
    ...
    value:
      ...
      | ICustomCheckpointMeta[K]
      | shared.InterfaceValueByKey<ICustomCheckpointMeta, K, V, void>
  ): void {
    // TODO implement
  }
}
...
export class Entity extends WorldObject {
   ...
   */
  public declare pos: shared.Vector3;
  /**
  ...
  public setMeta<K extends string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomEntityMeta, K, unknown, void>
  ): void;
  public setMeta<K extends shared.ExtractStringKeys<ICustomEntityMeta>>(
    key: K,
  ...
  public setMeta<V extends any, K extends string = string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomEntityMeta, K, V, void>
  ): void;

  public setMeta<
    K extends string | shared.ExtractStringKeys<ICustomEntityMeta>,
    V extends any
  >(
    ...
    value:
      ...
      | ICustomEntityMeta[K]
      | shared.InterfaceValueByKey<ICustomEntityMeta, K, V, void>
  ): void {
    // TODO implement
  }
  public deleteMeta(key: string): void;

  public deleteMeta<K extends shared.ExtractStringKeys<ICustomEntityMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  public getMeta<K extends string>(key: Exclude<K, never>): unknown;
  public getMeta<K extends shared.ExtractStringKeys<ICustomEntityMeta>>(
    key: K
  ): ICustomEntityMeta[K];
  /** @deprecated See {@link ICustomEntityMeta} */
  ...
  public getMeta<
    K extends string | shared.ExtractStringKeys<ICustomEntityMeta>,
    V extends any
  >(key: Exclude<K, never> | string): unknown | ICustomEntityMeta[K] | V {
    // TODO implement
    return null;
  }
  public hasMeta(key: string): boolean;

  public hasMeta<K extends shared.ExtractStringKeys<ICustomEntityMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  >(key: K): shared.ICustomEntitySyncedMeta[K];
  /** @deprecated See {@link "alt-shared".ICustomEntitySyncedMeta} */

  public getSyncedMeta<
    K extends string | shared.ExtractStringKeys<shared.ICustomEntitySyncedMeta>,
    V extends any
  >(
    key: Exclude<K, never> | string
  ): unknown | shared.ICustomEntitySyncedMeta[K] | V {
    // TODO implement
    return null;
  }
  /**
  ...
  >(key: K): shared.ICustomEntityStreamSyncedMeta[K];
  /** @deprecated See {@link "alt-shared".ICustomEntityStreamSyncedMeta} */

  public getStreamSyncedMeta<
    K extends
      | string
      | shared.ExtractStringKeys<shared.ICustomEntityStreamSyncedMeta>,
    V extends any
  >(
    key: Exclude<K, never> | string
  ): unknown | shared.ICustomEntityStreamSyncedMeta[K] | V {
    // TODO implement
    return null;
  }
  /**
...
export class Player extends Entity {
  ...
  public setMeta<K extends string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomPlayerMeta, K, unknown, void>
  ): void;
  public setMeta<K extends shared.ExtractStringKeys<ICustomPlayerMeta>>(
    key: K,
  ...
  public setMeta<V extends any, K extends string = string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomPlayerMeta, K, V, void>
  ): void;

  public setMeta<
    K extends string | shared.ExtractStringKeys<ICustomPlayerMeta>,
    V extends any
  >(
    ...
    value:
      ...
      | ICustomPlayerMeta[K]
      | shared.InterfaceValueByKey<ICustomPlayerMeta, K, V, void>
  ): void {
    // TODO implement
  }
  public deleteMeta(key: string): void;

  public deleteMeta<K extends shared.ExtractStringKeys<ICustomPlayerMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  public getMeta<K extends string>(key: Exclude<K, never>): unknown;
  public getMeta<K extends shared.ExtractStringKeys<ICustomPlayerMeta>>(
    key: K
  ): ICustomPlayerMeta[K];
  /** @deprecated See {@link ICustomPlayerMeta} */
  ...
  public hasMeta<K extends shared.ExtractStringKeys<ICustomPlayerMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  >(key: K): shared.ICustomPlayerSyncedMeta[K];
  /** @deprecated See {@link "alt-shared".ICustomPlayerSyncedMeta} */

  public getSyncedMeta<
    K extends string | shared.ExtractStringKeys<shared.ICustomPlayerSyncedMeta>,
    V extends any
  >(
    key: Exclude<K, never> | string
  ): unknown | shared.ICustomPlayerSyncedMeta[K] | V {
    // TODO implement
    return null;
  }
  public hasSyncedMeta(key: string): boolean;
  ...
  >(key: K): shared.ICustomPlayerStreamSyncedMeta[K];
  /** @deprecated See {@link "alt-shared".ICustomPlayerStreamSyncedMeta} */

  public getStreamSyncedMeta<
    K extends
      | string
      | shared.ExtractStringKeys<shared.ICustomPlayerStreamSyncedMeta>,
    V extends any
  >(
    key: Exclude<K, never> | string
  ): unknown | shared.ICustomPlayerStreamSyncedMeta[K] | V {
    // TODO implement
    return null;
  }
  public hasStreamSyncedMeta(key: string): boolean;
...
export class LocalPlayer extends Player {
  public declare readonly dimension: number;
  public declare pos: shared.Vector3;
  public declare rot: shared.Vector3;
  /**
  ...
  public deleteMeta<K extends shared.ExtractStringKeys<ICustomLocalPlayerMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  ...
  public hasMeta<K extends shared.ExtractStringKeys<ICustomLocalPlayerMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public getMeta<K extends shared.ExtractStringKeys<ICustomLocalPlayerMeta>>(
    key: K
  ): ICustomLocalPlayerMeta[K];
  /** @deprecated See {@link ICustomLocalPlayerMeta} */

  public getMeta<
    K extends string | shared.ExtractStringKeys<ICustomLocalPlayerMeta>,
    V extends any
  >(key: Exclude<K, never> | string): unknown | ICustomLocalPlayerMeta[K] | V {
    // TODO implement
    return null;
  }
  public setMeta<K extends string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomLocalPlayerMeta, K, unknown, void>
  ): void;
  ...
  public setMeta<V extends any, K extends string = string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomLocalPlayerMeta, K, V, void>
  ): void;
  ...
  >(
    ...
    value:
      ...
      | ICustomLocalPlayerMeta[K]
      | shared.InterfaceValueByKey<ICustomLocalPlayerMeta, K, V, void>
  ): void {
    // TODO implement
  }
}
...
export class Vehicle extends Entity {
  ...
  public setMeta<K extends string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomVehicleMeta, K, unknown, void>
  ): void;
  public setMeta<K extends shared.ExtractStringKeys<ICustomVehicleMeta>>(
    key: K,
  ...
  public setMeta<V extends any, K extends string = string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomVehicleMeta, K, V, void>
  ): void;

  public setMeta<
    K extends string | shared.ExtractStringKeys<ICustomVehicleMeta>,
    V extends any
  >(
    ...
    value:
      ...
      | shared.InterfaceValueByKey<ICustomVehicleMeta, K, V, void>
  ): void {
    // TODO implement
  }
  public deleteMeta(key: string): void;

  public deleteMeta<K extends shared.ExtractStringKeys<ICustomVehicleMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  public getMeta<K extends string>(key: Exclude<K, never>): unknown;
  public getMeta<K extends shared.ExtractStringKeys<ICustomVehicleMeta>>(
    key: K
  ): ICustomVehicleMeta[K];
  /** @deprecated See {@link ICustomVehicleMeta} */
  ...
  public hasMeta<K extends shared.ExtractStringKeys<ICustomVehicleMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  >(key: K): shared.ICustomVehicleSyncedMeta[K];
  /** @deprecated See {@link "alt-shared".ICustomVehicleSyncedMeta} */

  public getSyncedMeta<
    K extends
      | string
      | shared.ExtractStringKeys<shared.ICustomVehicleSyncedMeta>,
    V extends any
  >(
    key: Exclude<K, never> | string
  ): unknown | shared.ICustomVehicleSyncedMeta[K] | V {
    // TODO implement
    return null;
  }
  public hasSyncedMeta(key: string): boolean;
  ...
  >(key: K): shared.ICustomVehicleStreamSyncedMeta[K];
  /** @deprecated See {@link "alt-shared".ICustomVehicleStreamSyncedMeta} */

  public getStreamSyncedMeta<
    K extends
      | string
      | shared.ExtractStringKeys<shared.ICustomVehicleStreamSyncedMeta>,
    V extends any
  >(
    key: Exclude<K, never> | string
  ): unknown | shared.ICustomVehicleStreamSyncedMeta[K] | V {
    // TODO implement
    return null;
  }
  public hasStreamSyncedMeta(key: string): boolean;
...
export class WebView extends BaseObject {
  ...
  public deleteMeta<K extends shared.ExtractStringKeys<ICustomWebViewMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  ...
  public hasMeta<K extends shared.ExtractStringKeys<ICustomWebViewMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public getMeta<K extends string>(key: Exclude<K, never>): unknown;
  public getMeta<K extends shared.ExtractStringKeys<ICustomWebViewMeta>>(
    key: K
  ): ICustomWebViewMeta[K];
  /** @deprecated See {@link ICustomWebViewMeta} */

  public getMeta<
    K extends string | shared.ExtractStringKeys<ICustomWebViewMeta>,
    V extends any
  >(key: Exclude<K, never> | string): unknown | ICustomWebViewMeta[K] | V {
    // TODO implement
    return null;
  }
  public setMeta<K extends string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomWebViewMeta, K, unknown, void>
  ): void;
  public setMeta<K extends shared.ExtractStringKeys<ICustomWebViewMeta>>(
    key: K,
    value: ICustomWebViewMeta[K]
  ): void;
  /** @deprecated See {@link ICustomWebViewMeta} */
  public setMeta<V extends any, K extends string = string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomWebViewMeta, K, V, void>
  ): void;
  ...
  >(
    ...
    value:
      ...
      | ICustomWebViewMeta[K]
      | shared.InterfaceValueByKey<ICustomWebViewMeta, K, V, void>
  ): void {
    // TODO implement
  }
}
...
export class Blip extends WorldObject {
  ...
  public deleteMeta<K extends shared.ExtractStringKeys<ICustomBlipMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  ...
  public hasMeta<K extends shared.ExtractStringKeys<ICustomBlipMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public getMeta<K extends string>(key: Exclude<K, never>): unknown;
  public getMeta<K extends shared.ExtractStringKeys<ICustomBlipMeta>>(
    key: K
  ): ICustomBlipMeta[K];
  /** @deprecated See {@link ICustomBlipMeta} */

  public getMeta<
    K extends string | shared.ExtractStringKeys<ICustomBlipMeta>,
    V extends any
  ...
  public setMeta<K extends string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomBlipMeta, K, unknown, void>
  ): void;
  public setMeta<K extends shared.ExtractStringKeys<ICustomBlipMeta>>(
    key: K,
  ...
  public setMeta<V extends any, K extends string = string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomBlipMeta, K, V, void>
  ): void;
  ...
  >(
    ...
    value:
      ...
      | ICustomBlipMeta[K]
      | shared.InterfaceValueByKey<ICustomBlipMeta, K, V, void>
  ): void {
    // TODO implement
  }
}
...
export class WebSocketClient extends BaseObject {
  ...
  public on(
    eventName: "open" | "close" | "message" | "error",
    listener:
      | (() => void)
...
export class RmlDocument extends RmlElement {
  ...
  public declare readonly isVisible: boolean;
...
export class FocusData {
  ...
  public static overrideFocus(
    pos: shared.Vector3 | Entity,
    offset: shared.Vector3
  ): void {
    // TODO implement
  }
...
export class LocalObject extends Object {
  ...
  public declare static readonly all: readonly LocalObject[];
  /**
  ...
  public declare static readonly count: number;
  public declare pos: shared.Vector3;
  public declare rot: shared.Vector3;
  public static get model(): number {
    // TODO Implement
  ...
  public declare textureVariation: number;
...
export class WeaponObject extends LocalObject {
  ...
  public declare static readonly all: readonly WeaponObject[];
  public declare static readonly count: number;
...
export class Ped extends Entity {
  ...
  public setMeta<K extends string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomPedMeta, K, unknown, void>
  ): void;
  public setMeta<K extends shared.ExtractStringKeys<ICustomPedMeta>>(
    key: K,
    value: ICustomPedMeta[K]
  ): void;

  public setMeta<K extends string | shared.ExtractStringKeys<ICustomPedMeta>>(
    key: K | shared.MetaValues<ICustomPedMeta>,
    value:
      | shared.InterfaceValueByKey<ICustomPedMeta, K, unknown, void>
      | ICustomPedMeta[K]
  ): void {
    // TODO implement
  }
  ...
  public deleteMeta<K extends shared.ExtractStringKeys<ICustomPedMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  ...
  public getMeta<K extends string | shared.ExtractStringKeys<ICustomPedMeta>>(
    key: Exclude<K, never>
  ): unknown | ICustomPedMeta[K] {
    // TODO implement
    return null;
  }
  public hasMeta(key: string): boolean;

  public hasMeta<K extends shared.ExtractStringKeys<ICustomPedMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public getSyncedMeta<
    K extends string | shared.ExtractStringKeys<shared.ICustomPedSyncedMeta>
  >(key: Exclude<K, never>): unknown | shared.ICustomPedSyncedMeta[K] {
    // TODO implement
    return null;
  }
  public hasSyncedMeta(key: string): boolean;
  ...
  public getStreamSyncedMeta<
    K extends
      | string
      | shared.ExtractStringKeys<shared.ICustomPedStreamSyncedMeta>
  >(key: Exclude<K, never>): unknown | shared.ICustomPedStreamSyncedMeta[K] {
    // TODO implement
    return null;
  }
  public hasStreamSyncedMeta(key: string): boolean;
...
export class Colshape extends WorldObject {
  ...
  public deleteMeta<K extends shared.ExtractStringKeys<ICustomColshapeMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  ...
  public hasMeta<K extends shared.ExtractStringKeys<ICustomColshapeMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public getMeta<K extends string>(key: Exclude<K, never>): unknown;
  public getMeta<K extends shared.ExtractStringKeys<ICustomColshapeMeta>>(
    key: K
  ): ICustomColshapeMeta[K];
  /** @deprecated See {@link ICustomColshapeMeta} */

  public getMeta<
    K extends string | shared.ExtractStringKeys<ICustomColshapeMeta>,
    V extends any
  ...
  public setMeta<K extends string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomColshapeMeta, K, unknown, void>
  ): void;
  ...
  public setMeta<V extends any, K extends string = string>(
    key: K,
    value: shared.InterfaceValueByKey<ICustomColshapeMeta, K, V, void>
  ): void;
  ...
  >(
    ...
    value:
      ...
      | ICustomColshapeMeta[K]
      | shared.InterfaceValueByKey<ICustomColshapeMeta, K, V, void>
  ): void {
    // TODO implement
  }
}
...
export class LocalVehicle extends Vehicle {
  ...
  public readonly streamingDistance: number;
  public declare visible: boolean;
  public declare readonly scriptID: number;
  public readonly isStreamedIn: boolean;
  /**
   * Vehicle wheels speed.
   */
  public declare readonly speed: number;
  /**
   * Vehicle gear.
   *
   * @returns A number indicating actual gear.
   */
  public declare gear: number;
  /**
   * Vehicle max gear.
   */
  public declare readonly maxGear: number;
  /**
   * Vehicle RPM.
   *
   * @returns Normalised value on a scale of [0, 1].
   */
  public declare rpm: number;
  /**
   * Vehicle wheels count.
   */
  public declare readonly wheelsCount: number;
  /**
   * Vehicle speed vector.
   */
  public declare readonly speedVector: shared.Vector3;
  /**
   * Vehicle engine state.
   */
  public declare readonly engineOn: boolean;
  /**
   * Vehicle lock state.
   */
  public declare readonly lockState: shared.VehicleLockState;
  /**
   * The vehicle's petrol tank health.
   */
  public declare readonly petrolTankHealth: number;
  /**
   * Vehicle indicator lights.
   */
  public declare indicatorLights: VehicleIndicatorLights;
  /**
   * Vehicle seat count.
   */
  public declare readonly seatCount: number;
  /**
   * The vehicle's engine temperature.
   */
  public declare engineTemperature: number;
  /**
   * The vehicle's fuel level.
   */
  public declare fuelLevel: number;
  /**
   * The vehicle's oil level.
   */
  public declare oilLevel: number;
