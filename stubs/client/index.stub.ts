...
export function getPermissionState<T extends number>(xOrValue: shared.Permission | T): boolean {
    // TODO Implement
    return false;
}
/**
...
export function getStat(statName: `${StatName}`): number;
export function getStat(xOrValue: StatName | 'stamina' | 'strength' | 'lung_capacity' | 'wheelie_ability' | 'flying_ability' | 'shooting_ability' | 'stealth_ability'): number {
    // TODO Implement
    return 0;
}
/**
...
export function resetStat(statName: `${StatName}`): void;
export function resetStat(xOrValue: StatName | 'stamina' | 'strength' | 'lung_capacity' | 'wheelie_ability' | 'flying_ability' | 'shooting_ability' | 'stealth_ability'): void {
    // TODO Implement
}
/**
...
export function setStat(statName: `${StatName}`, value: number): void;
export function setStat(xOrValue: StatName | 'stamina' | 'strength' | 'lung_capacity' | 'wheelie_ability' | 'flying_ability' | 'shooting_ability' | 'stealth_ability', y?: number): void {
    // TODO Implement
}
/**
...
export function worldToScreen(xOrValue: number | shared.IVector3, y?: number): shared.Vector3 {
    // TODO Implement
    return null;
}
/**
...
export function getLocalMeta<K extends shared.ExtractStringKeys<shared.ICustomPlayerLocalMeta>>(xOrValue: Exclude<K, never> | K): shared.ICustomPlayerLocalMeta[K] {
    // TODO Implement
    return null;
}
...
export function hasLocalMeta<K extends shared.ExtractStringKeys<shared.ICustomPlayerLocalMeta>>(xOrValue: string | K): boolean {
    // TODO Implement
    return false;
}
/**
 ...
 * @param sizeY Same as sizeY field in fontend.xml.
 */
export function setMinimapComponentPosition(xOrValue: string, y?: string): void {
    // TODO Implement
}
/**
...
export function isPointOnScreen(xOrValue: number | shared.IVector3, y?: number): boolean {
    // TODO Implement
    return false;
}
...
export class Audio extends BaseObject {
    ...
    public setMeta<K extends string | shared.ExtractStringKeys<ICustomAudioMeta>, V extends any>(values: shared.MetaValues<ICustomAudioMeta>, value: shared.InterfaceValueByKey<ICustomAudioMeta, K, V, void>): void {
        // TODO implement
    }
}
...
export class Checkpoint extends WorldObject {
    ...
    public setMeta<K extends string | shared.ExtractStringKeys<ICustomCheckpointMeta>, V extends any>(
        values: shared.MetaValues<ICustomCheckpointMeta>,
...
export class LocalPlayer extends Player {
    ...
    public setMeta<K extends string | shared.ExtractStringKeys<ICustomLocalPlayerMeta>, V extends any>(
        values: shared.MetaValues<ICustomLocalPlayerMeta>,
...
export class WebView extends BaseObject {
    ...
    public setMeta<K extends string | shared.ExtractStringKeys<ICustomWebViewMeta>, V extends any>(values: shared.MetaValues<ICustomWebViewMeta>, value: shared.InterfaceValueByKey<ICustomWebViewMeta, K, V, void>): void {
        // TODO implement
    }
}
export class Worker {
...
export class Voice {
     ...
     */
    public static set activityInputEnabled(value: boolean) {
        // TODO Implement
    }
    /**
...
export class AudioFilter extends BaseObject {
    ...
    public set audioCategory(value: string | number) {
        // TODO Implement
    }
...
export namespace Utils {
    ...
    export function drawText2dThisFrame(
        text: string,
        pos2d?: import('alt-shared').IVector2,
        font?: import('alt-client').GameFont,
        scale?: number,
        color?: import('alt-shared').RGBA,
        outline?: boolean,
        dropShadow?: boolean,
        textAlign?: import('alt-client').TextAlign,
    ): void {
        // TODO Implement
    }
    export function drawText2d(
        ...
        dropShadow?: boolean,
        textAlign?: import('alt-client').TextAlign,
    ): import('alt-shared').Utils.EveryTick {
        // TODO Implement
        return null;
    }
    export function drawText3dThisFrame(
        text: string,
        pos3d: import('alt-shared').IVector3,
        font?: import('alt-client').GameFont,
        scale?: number,
        color?: import('alt-shared').RGBA,
        outline?: boolean,
    ...
    export function loadMapArea(pos: import('alt-shared').IVector3, radius?: number, timeout?: number): Promise<void> {
        // TODO Implement
        return null;
    }
    export function registerPedheadshotBase64(ped: number | import('alt-client').Player): Promise<string> {
        // TODO Implement
        return null;
    }
    export function registerPedheadshot3Base64(ped: number | import('alt-client').Player): Promise<string> {
        // TODO Implement
        return null;
    }
    export function registerPedheadshotTransparentBase64(ped: number | import('alt-client').Player): Promise<string> {
        // TODO Implement
        return null;
    }
    export function getClosestPlayer(options?: { pos?: import('alt-shared').IVector3; range?: number }): import('alt-client').Player {
        // TODO Implement
        return null;
    }
    export function getClosestVehicle(options?: { pos?: import('alt-shared').IVector3; range?: number }): import('alt-client').Vehicle {
        // TODO Implement
        return null;
    }
    export function getClosestObject(options?: { pos?: import('alt-shared').IVector3; range?: number }): import('alt-client').Object {
        // TODO Implement
        return null;
    }
    export function getClosestWorldObject(options?: { pos?: import('alt-shared').IVector3; range?: number }): import('alt-client').Object {
        // TODO Implement
        return null;
    }
    export function getClosestVirtualEntity(options?: { pos?: import('alt-shared').IVector3; range?: number }): import('alt-client').VirtualEntity {
        // TODO Implement
        return null;
    }
