...
export function getLocale(): `${Locale}`;
export function getLocale(): "ar" | "by" | "cz" | "de" | "en" | "es" | "fa" | "fr" | "he" | "hu" | "id" | "in_hd" | "in_ml" | "in_tl" | "in_tm" | "it" | "lt" | "lv" | "nb_no" | "nn_no" | "pl" | "pt" | "pt_br" | "ro" | "rs" | "ru" | "sk" | "th" | "tr" | "ua" | "zh_cn" | "zh_tw" {
  // TODO Implement
  return null;
}
...
export function setConfigFlag(flag: `${ConfigFlag}`, state: boolean): void;
export function setConfigFlag(flag: "DISABLE_AUTO_WEAPON_SWAP" | "DISABLE_PED_PROP_KNOCK_OFF" | "DISABLE_IDLE_CAMERA" | "DISABLE_VEHICLE_ENGINE_SHUTDOWN_ON_LEAVE" | "DISABLE_SP_ENTER_VEHICLE_CLIPSET" | "FORCE_RENDER_SNOW" | "FORCE_HIDE_NIGHT_PROPS" | "FORCE_SHOW_NIGHT_PROPS" | "DISABLE_EMISSIVE_LIGHTS_RENDERING" | "FORCE_VEHICLE_TYRE_BURST" | "SWAP_ALLOW_HEAD_PROP_IN_VEHICLE_FLAG", state: boolean): void {
  // TODO Implement
...
export function getConfigFlag(flag: `${ConfigFlag}`): boolean;
export function getConfigFlag(flag: "DISABLE_AUTO_WEAPON_SWAP" | "DISABLE_PED_PROP_KNOCK_OFF" | "DISABLE_IDLE_CAMERA" | "DISABLE_VEHICLE_ENGINE_SHUTDOWN_ON_LEAVE" | "DISABLE_SP_ENTER_VEHICLE_CLIPSET" | "FORCE_RENDER_SNOW" | "FORCE_HIDE_NIGHT_PROPS" | "FORCE_SHOW_NIGHT_PROPS" | "DISABLE_EMISSIVE_LIGHTS_RENDERING" | "FORCE_VEHICLE_TYRE_BURST" | "SWAP_ALLOW_HEAD_PROP_IN_VEHICLE_FLAG"): boolean {
  // TODO Implement
  return false;
}
...
export function drawText2d(text: string, pos2d?: shared.IVector2, font?: GameFont, scale?: number, color?: shared.RGBA, outline?: boolean, dropShadow?: boolean, textAlign?: TextAlign): Utils.EveryTick {
  // TODO Implement
  return null;
}
...
export function drawText3d(text: string, pos3d: shared.IVector3, font?: GameFont, scale?: number, color?: shared.RGBA, outline?: boolean, dropShadow?: boolean, textAlign?: TextAlign): Utils.EveryTick {
  // TODO Implement
  return null;
}
...
export class Audio extends BaseObject {
  ...
  public on(event: "inited" | "streamStarted" | "streamEnded" | "streamPaused" | "streamReset" | "streamSeek" | "volumeChange" | "error", callback: (() => void) | ((time: number) => void) | ((vol: number) => void) | ((code: number, message: string) => void)): void {
    // TODO implement
...
export function drawText2dThisFrame(text: string, pos2d?: import("alt-shared").IVector2, font?: import("alt-client").GameFont, scale?: number, color?: import("alt-shared").RGBA, outline?: boolean, dropShadow?: boolean, textAlign?: import("alt-client").TextAlign): void {
  // TODO Implement

}

export function drawText2d(text: string, pos2d?: import("alt-shared").IVector2, font?: import("alt-client").GameFont, scale?: number, color?: import("alt-shared").RGBA, outline?: boolean, dropShadow?: boolean, textAlign?: import("alt-client").TextAlign): import("alt-shared").Utils.EveryTick {
  // TODO Implement
  return null;
}

export function drawText3dThisFrame(text: string, pos3d: import("alt-shared").IVector3, font?: import("alt-client").GameFont, scale?: number, color?: import("alt-shared").RGBA, outline?: boolean, dropShadow?: boolean, textAlign?: import("alt-client").TextAlign): void {
  // TODO Implement

}

export function drawText3d(text: string, pos3d: import("alt-shared").IVector3, font?: import("alt-client").GameFont, scale?: number, color?: import("alt-shared").RGBA, outline?: boolean, dropShadow?: boolean, textAlign?: import("alt-client").TextAlign): import("alt-shared").Utils.EveryTick {
  // TODO Implement
  return null;
}
...
export class WebView extends BaseObject {
  ...
  public constructor(url?: string, isOverlay?: boolean, pos?: shared.IVector2, size?: shared.IVector2, drawableHash?: number, targetTexture?: string, params?: IWebViewParams) {
    super();
    // TODO: Implement constructor
  }
...
export class WeaponObject extends LocalObject {
  ...
  public constructor(weaponHash?: string | number, pos?: shared.Vector3, rot?: shared.Vector3, modelHash?: string | number, numAmmo?: number, createDefaultComponents?: boolean, scale?: number, useStreaming?: boolean, streamingDistance?: number) {
    super(pos, rot, useStreaming, streamingDistance);
    // TODO: Implement constructor
  }
