...
export function setSyncedMeta<K extends shared.ExtractStringKeys<shared.ICustomGlobalSyncedMeta>>(
    xOrValue: K,
    y?: shared.InterfaceValueByKey<shared.ICustomGlobalSyncedMeta, K, unknown, void> | shared.ICustomGlobalSyncedMeta[K],
): void {
    // TODO Implement
}
...
export function deleteSyncedMeta<K extends shared.ExtractStringKeys<shared.ICustomGlobalSyncedMeta>>(xOrValue: string | K): void {
    // TODO Implement
}
/**
...
export function emitClient<K extends string>(xOrValue: Player | Player[], y?: K | Exclude<K, never>): void {
    // TODO Implement
}
/**
 * Emits specified event to specific client.
...
export function emitClientRaw<K extends string>(xOrValue: Player | Player[], y?: K | Exclude<K, never>): void {
    // TODO Implement
}
/**
 * Emits specified event to specific client.
...
export function emitClientUnreliable<K extends string>(xOrValue: Player | Player[], y?: K | Exclude<K, never>): void {
    // TODO Implement
}
/**
...
export class BaseObject extends shared.BaseObject {
    ...
    public setMeta<K extends string | shared.ExtractStringKeys<ICustomBaseObjectMeta>, V extends any>(
        values: shared.MetaValues<ICustomBaseObjectMeta>,
    ...
    public setSyncedMeta<K extends string | shared.ExtractStringKeys<shared.ICustomBaseObjectSyncedMeta>, V extends any>(
        values: shared.MetaValues<shared.ICustomBaseObjectSyncedMeta>,
        value: shared.InterfaceValueByKey<shared.ICustomBaseObjectSyncedMeta, K, V, void>,
    ): void {
        // TODO implement
    }
}
...
export class VirtualEntity extends WorldObject {
    ...
    public setStreamSyncedMeta<K extends string | shared.ExtractStringKeys<shared.ICustomVirtualEntityStreamSyncedMeta>, V extends any>(
        values: shared.MetaValues<shared.ICustomVirtualEntityStreamSyncedMeta>,
        value: shared.InterfaceValueByKey<shared.ICustomVirtualEntityStreamSyncedMeta, K, V, void>,
    ): void {
        // TODO implement
    }
    /**
...
export class Entity extends WorldObject {
    ...
    public setMeta<K extends string | shared.ExtractStringKeys<ICustomEntityMeta>, V extends any>(values: shared.MetaValues<ICustomEntityMeta>, value: shared.InterfaceValueByKey<ICustomEntityMeta, K, V, void>): void {
        // TODO implement
    }
    public deleteMeta(key: string): void;
    ...
    public setSyncedMeta<K extends string | shared.ExtractStringKeys<shared.ICustomEntitySyncedMeta>, V extends any>(
        values: shared.MetaValues<shared.ICustomEntitySyncedMeta>,
        value: shared.InterfaceValueByKey<shared.ICustomEntitySyncedMeta, K, V, void>,
    ): void {
        // TODO implement
    }
    /**
    ...
    public setStreamSyncedMeta<K extends string | shared.ExtractStringKeys<shared.ICustomEntityStreamSyncedMeta>, V extends any>(
        values: shared.MetaValues<shared.ICustomEntityStreamSyncedMeta>,
        value: shared.InterfaceValueByKey<shared.ICustomEntityStreamSyncedMeta, K, V, void>,
    ): void {
        // TODO implement
    }
    /**
...
export class Player extends Entity {
    ...
    public emit<K extends keyof shared.ICustomServerClientEvent | string>(eventName: Exclude<K, never>, ...args: any[]): void {
        // TODO implement
    }
    /**
    ...
    public emitRaw<K extends keyof shared.ICustomServerClientEvent | string>(eventName: Exclude<K, never>, ...args: any[]): void {
        // TODO implement
    }
    /**
    ...
    public setLocalMeta<K extends string | shared.ExtractStringKeys<shared.ICustomPlayerLocalMeta>, V extends any>(
        values: shared.MetaValues<shared.ICustomPlayerLocalMeta>,
        value: shared.InterfaceValueByKey<shared.ICustomPlayerLocalMeta, K, V, void>,
    ): void {
        // TODO implement
    }
    ...
    public setMeta<K extends string | shared.ExtractStringKeys<ICustomPlayerMeta>, V extends any>(values: shared.MetaValues<ICustomPlayerMeta>, value: shared.InterfaceValueByKey<ICustomPlayerMeta, K, V, void>): void {
        // TODO implement
    }
    public deleteMeta(key: string): void;
    ...
    public setSyncedMeta<K extends string | shared.ExtractStringKeys<shared.ICustomPlayerSyncedMeta>, V extends any>(
        values: shared.MetaValues<shared.ICustomPlayerSyncedMeta>,
        value: shared.InterfaceValueByKey<shared.ICustomPlayerSyncedMeta, K, V, void>,
    ): void {
        // TODO implement
    }
    public deleteSyncedMeta(key: string): void;
    ...
    public setStreamSyncedMeta<K extends string | shared.ExtractStringKeys<shared.ICustomPlayerStreamSyncedMeta>, V extends any>(
        values: shared.MetaValues<shared.ICustomPlayerStreamSyncedMeta>,
        value: shared.InterfaceValueByKey<shared.ICustomPlayerStreamSyncedMeta, K, V, void>,
    ): void {
        // TODO implement
    }
    public deleteStreamSyncedMeta(key: string): void;
...
export class Vehicle extends Entity {
    ...
    constructor(model: string | number, xOrPos: number | shared.IVector3, yOrRot?: number | shared.IVector3, z?: number, rx?: number, ry?: number, rz?: number, streamingDistance?: number) {
        super();
    }
    /**
    ...
    public getBumperDamageLevel<T extends number, V extends number>(bumperId: T): VehicleBumperDamage | V {
        // TODO implement
        return null;
    }
    /**
    ...
    public getDoorState<T extends number, V extends number>(doorId: T): VehicleDoorState | V {
        // TODO implement
        return null;
    }
    /**
    ...
    public getPartDamageLevel<T extends number, V extends number>(partId: T): VehiclePartDamage | V {
        // TODO implement
        return null;
    }
    /**
    ...
    public setBumperDamageLevel<T extends number, V extends number>(bumperId: T, level: V): void {
        // TODO implement
    }
    /**
    ...
    public setDoorState<T extends number, V extends number>(doorId: T, state: V): void {
        // TODO implement
    }
    /**
    ...
    public setPartDamageLevel<T extends number, V extends number>(partId: T, level: V): void {
        // TODO implement
    }
    /**
    ...
    public setMeta<K extends string | shared.ExtractStringKeys<ICustomVehicleMeta>, V extends any>(values: shared.MetaValues<ICustomVehicleMeta>, value: shared.InterfaceValueByKey<ICustomVehicleMeta, K, V, void>): void {
        // TODO implement
    }
    public deleteMeta(key: string): void;
    ...
    public setSyncedMeta<K extends string | shared.ExtractStringKeys<shared.ICustomVehicleSyncedMeta>, V extends any>(
        values: shared.MetaValues<shared.ICustomVehicleSyncedMeta>,
        value: shared.InterfaceValueByKey<shared.ICustomVehicleSyncedMeta, K, V, void>,
    ): void {
        // TODO implement
    }
    public deleteSyncedMeta(key: string): void;
    ...
    public setStreamSyncedMeta<K extends string | shared.ExtractStringKeys<shared.ICustomVehicleStreamSyncedMeta>, V extends any>(
        values: shared.MetaValues<shared.ICustomVehicleStreamSyncedMeta>,
        value: shared.InterfaceValueByKey<shared.ICustomVehicleStreamSyncedMeta, K, V, void>,
    ): void {
        // TODO implement
    }
    public deleteStreamSyncedMeta(key: string): void;
...
export class Blip extends WorldObject {
    ...
    public setMeta<K extends string | shared.ExtractStringKeys<ICustomBlipMeta>, V extends any>(values: shared.MetaValues<ICustomBlipMeta>, value: shared.InterfaceValueByKey<ICustomBlipMeta, K, V, void>): void {
        // TODO implement
    }
}
...
export class PointBlip extends Blip {
    ...
    public constructor(xOrPosOrEntity?: number | shared.Vector3 | Entity, yOrGlobal?: number | boolean, z?: number, global?: boolean) {
        super();
...
export class Colshape extends WorldObject {
    ...
    public setMeta<K extends string | shared.ExtractStringKeys<ICustomColshapeMeta>, V extends any>(
        values: shared.MetaValues<ICustomColshapeMeta>,
...
export class VoiceChannel extends BaseObject {
    ...
    public setMeta<K extends string | shared.ExtractStringKeys<ICustomVoiceChannelMeta>, V extends any>(
        values: shared.MetaValues<ICustomVoiceChannelMeta>,
        value: shared.InterfaceValueByKey<ICustomVoiceChannelMeta, K, V, void>,
    ): void {
        // TODO implement
    }
}
