...
import { Vector3, BodyPart, VoiceConnectionState, ModelType, IVector3, InterfaceValueByKey, ICustomGlobalSyncedMeta, ExtractStringKeys, ICustomServerClientEvent, ICustomClientServerRpc, ICustomClientServerEvent, EventParameters, BaseObjectType, MetaValues, ICustomBaseObjectSyncedMeta, ICustomVirtualEntityStreamSyncedMeta, ICustomEntitySyncedMeta, ICustomEntityStreamSyncedMeta, IWeapon, ICustomServerClientRpc, RGBA, ICustomPlayerLocalMeta, ICustomPlayerSyncedMeta, ICustomPlayerStreamSyncedMeta, VehicleLockState, Quaternion, ICustomVehicleSyncedMeta, ICustomVehicleStreamSyncedMeta, BlipSprite, Vector2, BlipColor, BlipType, ColShapeType, IVector2, CheckpointType, ICustomCheckpointStreamSyncedMeta, MarkerType } from "alt-shared";
