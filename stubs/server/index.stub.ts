...
import {
  ...
  IVector2,
  CheckpointType,
  ICustomCheckpointStreamSyncedMeta,
  MarkerType,
} from "alt-shared";
...
export function getClosestPlayer(options: {
  pos: IVector3;
  range?: number;
}): Player | null;
/**
...
export function getClosestVehicle(options: {
  pos: IVector3;
  range?: number;
}): Vehicle | null;
/**
...
export function setSyncedMeta<K extends string>(
  key: K,
  value: InterfaceValueByKey<ICustomGlobalSyncedMeta, K>
): void;
export function setSyncedMeta<
  K extends ExtractStringKeys<ICustomGlobalSyncedMeta>
>(key: K, value: ICustomGlobalSyncedMeta[K]): void;
export function setSyncedMeta<V extends any, K extends string = string>(
  key: K,
  value: InterfaceValueByKey<ICustomGlobalSyncedMeta, K, V>
): void;
/** @deprecated See {@link "alt-shared".ICustomGlobalSyncedMeta} */
export function setSyncedMeta<V extends any, K extends string = string>(
  key: K,
  value: InterfaceValueByKey<ICustomGlobalSyncedMeta, K, V, void>
): void {
  // TODO Implement
}

export function deleteSyncedMeta(key: string): void;
export function deleteSyncedMeta<
  K extends ExtractStringKeys<ICustomGlobalSyncedMeta>
>(key: K): void;
export function deleteSyncedMeta<
  K extends ExtractStringKeys<ICustomGlobalSyncedMeta>
...
export function emit<K extends keyof ICustomEmitEvent>(
  eventName: K,
...
export function emitClient<K extends keyof ICustomServerClientEvent>(
  player: Player | Player[],
  eventName: K,
  ...args: Parameters<ICustomServerClientEvent[K]>
): void;
...
export function emitClient<K extends string>(
  player: Player | Player[],
  eventName: Exclude<K, never>,
  args: any[]
): void {
  // TODO Implement
}

export function emitClientRaw<K extends keyof ICustomServerClientEvent>(
  player: Player | Player[],
  eventName: K,
  ...args: Parameters<ICustomServerClientEvent[K]>
): void;
...
export function emitClientUnreliable<K extends keyof ICustomServerClientEvent>(
  player: Player | Player[],
  eventName: K,
  ...args: Parameters<ICustomServerClientEvent[K]>
): void;
...
export function emitAllClients<K extends keyof ICustomServerClientEvent>(
  eventName: K,
  ...args: Parameters<ICustomServerClientEvent[K]>
): void;
...
export function emitAllClientsRaw<K extends keyof ICustomServerClientEvent>(
  eventName: K,
  ...args: Parameters<ICustomServerClientEvent[K]>
): void;
...
export function emitAllClientsUnreliable<
  K extends keyof ICustomServerClientEvent
>(eventName: K, ...args: Parameters<ICustomServerClientEvent[K]>): void;
...
export function onRpc<K extends keyof ICustomClientServerRpc>(
  rpcName: K,
  listener: (
    player: Player,
    ...args: Parameters<ICustomClientServerRpc[K]>
  ) =>
    | Promise<ReturnType<ICustomClientServerRpc[K]>>
    | ReturnType<ICustomClientServerRpc[K]>
): void;
...
export function onRpc<K extends string>(
  rpcName: Exclude<K, never>,
  listener: (player: Player, ...args: any[]) => any
): void {
  // TODO Implement
}

export function offRpc<K extends keyof ICustomClientServerRpc>(
  rpcName: string,
  listener: (
    player: Player,
    ...args: Parameters<ICustomClientServerRpc[K]>
...
export function offClient<K extends keyof ICustomClientServerEvent>(
  eventName: K,
  listener: (
    player: Player,
    ...args: Parameters<ICustomClientServerEvent[K]>
  ) => void
): void;
export function offClient<K extends string>(
  eventName: Exclude<K, keyof ICustomClientServerEvent>,
...
export function on<K extends keyof IServerEvent | keyof ICustomEmitEvent>(
  eventName: K,
  listener: (
    ...args: EventParameters<IServerEvent, ICustomEmitEvent, K>
  ) => void
): void;
...
export function onClient<K extends keyof ICustomClientServerEvent>(
  eventName: K,
  listener: (
    player: Player,
    ...args: Parameters<ICustomClientServerEvent[K]>
...
export function onceClient<K extends keyof ICustomClientServerEvent>(
  eventName: K,
  listener: (
    player: Player,
    ...args: Parameters<ICustomClientServerEvent[K]>
...
export function getRemoteEventListeners(
...
export function getWeaponModelInfoByHash(
...
export class BaseObject extends BaseObject_1 {
  ...
  public deleteMeta<K extends ExtractStringKeys<ICustomBaseObjectMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  ...
  public hasMeta<K extends ExtractStringKeys<ICustomBaseObjectMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public getMeta<K extends ExtractStringKeys<ICustomBaseObjectMeta>>(
    key: K
  ): ICustomBaseObjectMeta[K];
  /** @deprecated See {@link ICustomBaseObjectMeta} */

  public getMeta<
    K extends string | ExtractStringKeys<ICustomBaseObjectMeta>,
    V extends any
  >(key: Exclude<K, never> | string): unknown | ICustomBaseObjectMeta[K] | V {
    // TODO implement
    return null;
  }
  public setMeta<K extends string>(
    key: K,
    value: InterfaceValueByKey<ICustomBaseObjectMeta, K, unknown, void>
  ): void;
  public setMeta<K extends ExtractStringKeys<ICustomBaseObjectMeta>>(
    key: K,
  ...
  public setMeta<V extends any, K extends string = string>(
    key: K,
    value: InterfaceValueByKey<ICustomBaseObjectMeta, K, V, void>
  ): void;
  ...
  >(
    ...
    value:
      | InterfaceValueByKey<ICustomBaseObjectMeta, K, unknown, void>
      | ICustomBaseObjectMeta[K]
      | InterfaceValueByKey<ICustomBaseObjectMeta, K, V, void>
  ): void {
    // TODO implement
  }
  /**
  ...
  public deleteSyncedMeta<
    K extends ExtractStringKeys<ICustomBaseObjectSyncedMeta>
  >(key: string | K): void {
    // TODO implement
  }
  /**
  ...
  public setSyncedMeta<K extends string>(
    key: K,
    value: InterfaceValueByKey<ICustomBaseObjectSyncedMeta, K, unknown, void>
  ): void;
  public setSyncedMeta<
    K extends ExtractStringKeys<ICustomBaseObjectSyncedMeta>
  >(key: K, value: ICustomBaseObjectSyncedMeta[K]): void;
  /** @deprecated See {@link "alt-shared".ICustomBaseObjectSyncedMeta} */
  public setSyncedMeta<V extends any, K extends string = string>(
    key: K,
    value: InterfaceValueByKey<ICustomBaseObjectSyncedMeta, K, V, void>
  ): void;

  public setSyncedMeta<
    K extends string | ExtractStringKeys<ICustomBaseObjectSyncedMeta>,
    V extends any
  >(
    key: K | MetaValues<ICustomBaseObjectSyncedMeta>,
    value:
      | InterfaceValueByKey<ICustomBaseObjectSyncedMeta, K, unknown, void>
      | ICustomBaseObjectSyncedMeta[K]
      | InterfaceValueByKey<ICustomBaseObjectSyncedMeta, K, V, void>
  ): void {
    // TODO implement
  }
}
...
export class VirtualEntity extends WorldObject {
  ...
  public getStreamSyncedMeta<
    K extends ExtractStringKeys<ICustomVirtualEntityStreamSyncedMeta>
  >(key: K): ICustomVirtualEntityStreamSyncedMeta[K];
  /** @deprecated See {@link "alt-shared".ICustomVirtualEntityStreamSyncedMeta} */

  public getStreamSyncedMeta<
    K extends string | ExtractStringKeys<ICustomVirtualEntityStreamSyncedMeta>,
    V extends any
  >(
    key: Exclude<K, never> | string
  ): unknown | ICustomVirtualEntityStreamSyncedMeta[K] | V {
    // TODO implement
    return null;
  }
  /**
  ...
  public hasStreamSyncedMeta<
    K extends ExtractStringKeys<ICustomVirtualEntityStreamSyncedMeta>
  >(key: string | K): boolean {
    // TODO implement
    return false;
  }
  ...
  public setStreamSyncedMeta<
    K extends ExtractStringKeys<ICustomVirtualEntityStreamSyncedMeta>
  >(key: K, value: ICustomVirtualEntityStreamSyncedMeta[K]): void;
  /** @deprecated See {@link "alt-shared".ICustomVirtualEntityStreamSyncedMeta} */
  public setStreamSyncedMeta<V extends any, K extends string = string>(
    key: K,
    value: InterfaceValueByKey<ICustomVirtualEntityStreamSyncedMeta, K, V, void>
  ): void;
  ...
  public setStreamSyncedMeta<
    ...
    V extends any
  >(
    key: K | MetaValues<ICustomVirtualEntityStreamSyncedMeta>,
    value:
      | InterfaceValueByKey<
          ICustomVirtualEntityStreamSyncedMeta,
          K,
          ...
          void
        >
      | ICustomVirtualEntityStreamSyncedMeta[K]
      | InterfaceValueByKey<ICustomVirtualEntityStreamSyncedMeta, K, V, void>
  ): void {
    // TODO implement
  }
  /**
...
export class Entity extends WorldObject {
  ...
  public setMeta<K extends string>(
    key: K,
    value: InterfaceValueByKey<ICustomEntityMeta, K, unknown, void>
  ): void;
  public setMeta<K extends ExtractStringKeys<ICustomEntityMeta>>(
    key: K,
  ...
  public setMeta<V extends any, K extends string = string>(
    key: K,
    value: InterfaceValueByKey<ICustomEntityMeta, K, V, void>
  ): void;

  public setMeta<
    K extends string | ExtractStringKeys<ICustomEntityMeta>,
    V extends any
  >(
    key: K | MetaValues<ICustomEntityMeta>,
    value:
      | InterfaceValueByKey<ICustomEntityMeta, K, unknown, void>
      | ICustomEntityMeta[K]
      | InterfaceValueByKey<ICustomEntityMeta, K, V, void>
  ): void {
    // TODO implement
  }
  public deleteMeta(key: string): void;

  public deleteMeta<K extends ExtractStringKeys<ICustomEntityMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  public getMeta<K extends string>(key: Exclude<K, never>): unknown;
  public getMeta<K extends ExtractStringKeys<ICustomEntityMeta>>(
    key: K
  ): ICustomEntityMeta[K];
  /** @deprecated See {@link ICustomEntityMeta} */
  ...
  public getMeta<K extends ExtractStringKeys<ICustomEntityMeta>>(
    key: K
  ): ICustomEntityMeta[K] | unknown {
    // TODO implement
    return null;
  }
  public hasMeta(key: string): boolean;

  public hasMeta<K extends ExtractStringKeys<ICustomEntityMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public deleteSyncedMeta<K extends ExtractStringKeys<ICustomEntitySyncedMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  ...
  public getSyncedMeta<K extends ExtractStringKeys<ICustomEntitySyncedMeta>>(
    key: K
  ): ICustomEntitySyncedMeta[K];
  /** @deprecated See {@link "alt-shared".ICustomEntitySyncedMeta} */

  public getSyncedMeta<
    K extends string | ExtractStringKeys<ICustomEntitySyncedMeta>,
    V extends any
  >(key: Exclude<K, never> | string): unknown | ICustomEntitySyncedMeta[K] | V {
    // TODO implement
    return null;
  }
  /**
  ...
  public hasSyncedMeta<K extends ExtractStringKeys<ICustomEntitySyncedMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public setSyncedMeta<K extends string>(
    key: K,
    value: InterfaceValueByKey<ICustomEntitySyncedMeta, K, unknown, void>
  ): void;
  public setSyncedMeta<K extends ExtractStringKeys<ICustomEntitySyncedMeta>>(
    key: K,
    value: ICustomEntitySyncedMeta[K]
  ): void;
  /** @deprecated See {@link "alt-shared".ICustomEntitySyncedMeta} */
  public setSyncedMeta<V extends any, K extends string = string>(
    key: K,
    value: InterfaceValueByKey<ICustomEntitySyncedMeta, K, V, void>
  ): void;
  ...
  public setSyncedMeta<
    ...
    V extends any
  >(
    key: K | MetaValues<ICustomEntitySyncedMeta>,
    value:
      | InterfaceValueByKey<ICustomEntitySyncedMeta, K, unknown, void>
      | ICustomEntitySyncedMeta[K]
      | InterfaceValueByKey<ICustomEntitySyncedMeta, K, V, void>
  ): void {
    // TODO implement
  }
  /**
  ...
  public deleteStreamSyncedMeta<
    K extends ExtractStringKeys<ICustomEntityStreamSyncedMeta>
  >(key: string | K): void {
    // TODO implement
  }
  /**
  ...
  public getStreamSyncedMeta<
    K extends ExtractStringKeys<ICustomEntityStreamSyncedMeta>
  >(key: K): ICustomEntityStreamSyncedMeta[K];
  /** @deprecated See {@link "alt-shared".ICustomEntityStreamSyncedMeta} */

  public getStreamSyncedMeta<
    K extends string | ExtractStringKeys<ICustomEntityStreamSyncedMeta>,
    V extends any
  >(
    key: Exclude<K, never> | string
  ): unknown | ICustomEntityStreamSyncedMeta[K] | V {
    // TODO implement
    return null;
  }
  /**
  ...
  public setStreamSyncedMeta<K extends string>(
    key: K,
    value: InterfaceValueByKey<ICustomEntityStreamSyncedMeta, K, unknown, void>
  ): void;
  public setStreamSyncedMeta<
    K extends ExtractStringKeys<ICustomEntityStreamSyncedMeta>
  >(key: K, value: ICustomEntityStreamSyncedMeta[K]): void;
  /** @deprecated See {@link "alt-shared".ICustomEntityStreamSyncedMeta} */
  public setStreamSyncedMeta<V extends any, K extends string = string>(
    key: K,
    value: InterfaceValueByKey<ICustomEntityStreamSyncedMeta, K, V, void>
  ): void;
  ...
  public setStreamSyncedMeta<
    ...
    V extends any
  >(
    key: K | MetaValues<ICustomEntityStreamSyncedMeta>,
    value:
      | InterfaceValueByKey<ICustomEntityStreamSyncedMeta, K, unknown, void>
      | ICustomEntityStreamSyncedMeta[K]
      | InterfaceValueByKey<ICustomEntityStreamSyncedMeta, K, V, void>
  ): void {
    // TODO implement
  }
  /**
  ...
  public attachTo(
    entity: Entity,
    entityBone: string | number,
    ownBone: string | number,
    pos: IVector3,
    rot: IVector3,
...
export class Player extends Entity {
   ...
   * ```
   */
  public declare static readonly all: readonly Player[];
   ...
   */
  public emit<K extends keyof ICustomServerClientEvent>(
    eventName: K,
    args: Parameters<ICustomServerClientEvent[K]>
  ): void;

  public emit<K extends keyof ICustomServerClientEvent | string>(
    eventName: K | Exclude<K, never>,
    args: Parameters<ICustomServerClientEvent[K]> | any[]
  ): void {
    // TODO implement
  }
  /**
   ...
   * @param args Rest parameters for emit to send.
   */
  public emitRaw<K extends keyof ICustomServerClientEvent>(
    eventName: K,
    args: Parameters<ICustomServerClientEvent[K]>
  ): void;

  public emitRaw<K extends keyof ICustomServerClientEvent | string>(
    eventName: K | Exclude<K, never>,
    args: Parameters<ICustomServerClientEvent[K]> | any[]
  ): void {
    // TODO implement
   ...
   *
   */
  public emitRpc<K extends keyof ICustomServerClientRpc>(
    rpcName: K,
    args: Parameters<ICustomServerClientRpc[K]>
  ): Promise<ReturnType<ICustomServerClientRpc[K]>>;

  public emitRpc<K extends keyof ICustomServerClientRpc | string>(
    rpcName: K | Exclude<K, never>,
    args: Parameters<ICustomServerClientRpc[K]> | any[]
  ): Promise<ReturnType<ICustomServerClientRpc[K]>> | Promise<any> {
    // TODO implement
    return null;
  }
  ...
  public spawn(
    x: number | IVector3 | string | number,
    y: number | IVector3,
    z: number,
    delay: number
  ): void {
  ...
  public setHeadBlendPaletteColor(
    id: number,
    red: number,
    green: number,
    blue: number
  ...
  public setAmmoSpecialType(
    ammoHash: string | number,
    ammoSpecialType: AmmoSpecialType
  ): void {
    // TODO implement
  }
  ...
  public setLocalMeta<K extends string>(
    key: K,
    value: InterfaceValueByKey<ICustomPlayerLocalMeta, K, unknown, void>
  ): void;
  public setLocalMeta<K extends ExtractStringKeys<ICustomPlayerLocalMeta>>(
    key: K,
  ...
  public setLocalMeta<V extends any, K extends string = string>(
    key: K,
    value: InterfaceValueByKey<ICustomPlayerLocalMeta, K, V, void>
  ): void;

  public setLocalMeta<
    K extends string | ExtractStringKeys<ICustomPlayerLocalMeta>,
    V extends any
  >(
    key: K | MetaValues<ICustomPlayerLocalMeta>,
    value:
      | InterfaceValueByKey<ICustomPlayerLocalMeta, K, unknown, void>
      | ICustomPlayerLocalMeta[K]
      | InterfaceValueByKey<ICustomPlayerLocalMeta, K, V, void>
  ): void {
    // TODO implement
  }
  public deleteLocalMeta(key: string): void;

  public deleteLocalMeta<K extends ExtractStringKeys<ICustomPlayerLocalMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  ...
  public getLocalMeta<K extends ExtractStringKeys<ICustomPlayerLocalMeta>>(
    key: K
  ): ICustomPlayerLocalMeta[K];
  /** @deprecated See {@link "alt-shared".ICustomPlayerLocalMeta} */
  ...
  public getLocalMeta<
    K extends string | ExtractStringKeys<ICustomPlayerLocalMeta>,
    V extends any
  >(key: Exclude<K, never> | string): unknown | ICustomPlayerLocalMeta[K] | V {
    // TODO implement
    return null;
  }
  public hasLocalMeta(key: string): boolean;

  public hasLocalMeta<K extends ExtractStringKeys<ICustomPlayerLocalMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public setMeta<K extends string>(
    key: K,
    value: InterfaceValueByKey<ICustomPlayerMeta, K, unknown, void>
  ): void;
  public setMeta<K extends ExtractStringKeys<ICustomPlayerMeta>>(
    key: K,
  ...
  public setMeta<V extends any, K extends string = string>(
    key: K,
    value: InterfaceValueByKey<ICustomPlayerMeta, K, V, void>
  ): void;

  public setMeta<
    K extends string | ExtractStringKeys<ICustomPlayerMeta>,
    V extends any
  >(
    key: K | MetaValues<ICustomPlayerMeta>,
    value:
      | InterfaceValueByKey<ICustomPlayerMeta, K, unknown, void>
      | ICustomPlayerMeta[K]
      | InterfaceValueByKey<ICustomPlayerMeta, K, V, void>
  ): void {
    // TODO implement
  }
  public deleteMeta(key: string): void;

  public deleteMeta<K extends ExtractStringKeys<ICustomPlayerMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  public getMeta<K extends string>(key: Exclude<K, never>): unknown;
  public getMeta<K extends ExtractStringKeys<ICustomPlayerMeta>>(
    key: K
  ): ICustomPlayerMeta[K];
  /** @deprecated See {@link ICustomPlayerMeta} */
  ...
  public getMeta<
    K extends string | ExtractStringKeys<ICustomPlayerMeta>,
    V extends any
  >(key: Exclude<K, never> | string): unknown | ICustomPlayerMeta[K] | V {
    // TODO implement
    return null;
  }
  public hasMeta(key: string): boolean;

  public hasMeta<K extends ExtractStringKeys<ICustomPlayerMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public setSyncedMeta<K extends string>(
    key: K,
    value: InterfaceValueByKey<ICustomPlayerSyncedMeta, K, unknown, void>
  ): void;
  public setSyncedMeta<K extends ExtractStringKeys<ICustomPlayerSyncedMeta>>(
    key: K,
    value: ICustomPlayerSyncedMeta[K]
  ): void;
  /** @deprecated See {@link "alt-shared".ICustomPlayerSyncedMeta} */
  public setSyncedMeta<V extends any, K extends string = string>(
    key: K,
    value: InterfaceValueByKey<ICustomPlayerSyncedMeta, K, V, void>
  ): void;

  public setSyncedMeta<
    K extends string | ExtractStringKeys<ICustomPlayerSyncedMeta>,
    V extends any
  >(
    key: K | MetaValues<ICustomPlayerSyncedMeta>,
    value:
      | InterfaceValueByKey<ICustomPlayerSyncedMeta, K, unknown, void>
      | ICustomPlayerSyncedMeta[K]
      | InterfaceValueByKey<ICustomPlayerSyncedMeta, K, V, void>
  ): void {
    // TODO implement
  }
  public deleteSyncedMeta(key: string): void;

  public deleteSyncedMeta<K extends ExtractStringKeys<ICustomPlayerSyncedMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  public getSyncedMeta<K extends string>(key: Exclude<K, never>): unknown;
  public getSyncedMeta<K extends ExtractStringKeys<ICustomPlayerSyncedMeta>>(
    key: K
  ): ICustomPlayerSyncedMeta[K];
  /** @deprecated See {@link "alt-shared".ICustomPlayerSyncedMeta} */
  ...
  public getSyncedMeta<
    K extends string | ExtractStringKeys<ICustomPlayerSyncedMeta>,
    V extends any
  >(key: Exclude<K, never> | string): unknown | ICustomPlayerSyncedMeta[K] | V {
    // TODO implement
    return null;
  }
  public hasSyncedMeta(key: string): boolean;

  public hasSyncedMeta<K extends ExtractStringKeys<ICustomPlayerSyncedMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public setStreamSyncedMeta<K extends string>(
    key: K,
    value: InterfaceValueByKey<ICustomPlayerStreamSyncedMeta, K, unknown, void>
  ): void;
  public setStreamSyncedMeta<
    K extends ExtractStringKeys<ICustomPlayerStreamSyncedMeta>
  >(key: K, value: ICustomPlayerStreamSyncedMeta[K]): void;
  /** @deprecated See {@link "alt-shared".ICustomPlayerStreamSyncedMeta} */
  public setStreamSyncedMeta<V extends any, K extends string = string>(
    key: K,
    value: InterfaceValueByKey<ICustomPlayerStreamSyncedMeta, K, V, void>
  ): void;

  public setStreamSyncedMeta<
    K extends string | ExtractStringKeys<ICustomPlayerStreamSyncedMeta>,
    V extends any
  >(
    key: K | MetaValues<ICustomPlayerStreamSyncedMeta>,
    value:
      | InterfaceValueByKey<ICustomPlayerStreamSyncedMeta, K, unknown, void>
      | ICustomPlayerStreamSyncedMeta[K]
      | InterfaceValueByKey<ICustomPlayerStreamSyncedMeta, K, V, void>
  ): void {
    // TODO implement
  }
  public deleteStreamSyncedMeta(key: string): void;
  ...
  public getStreamSyncedMeta<
    K extends ExtractStringKeys<ICustomPlayerStreamSyncedMeta>
  >(key: K): ICustomPlayerStreamSyncedMeta[K];
  /** @deprecated See {@link "alt-shared".ICustomPlayerStreamSyncedMeta} */
  ...
  >(
    key: Exclude<K, never> | string
  ): unknown | ICustomPlayerStreamSyncedMeta[K] | V {
    // TODO implement
    return null;
  }
  public hasStreamSyncedMeta(key: string): boolean;
...
export class Vehicle extends Entity {
   ...
   * ```
   */
  public declare static readonly all: readonly Vehicle[];
  public static readonly count: number;
  /**
  ...
  public getBumperDamageLevel<T extends number, V extends number>(
    bumperId: VehicleBumper | T
  ): VehicleBumperDamage | V {
    // TODO implement
    return null;
  }
  /**
  ...
  public getDoorState<T extends number, V extends number>(
    doorId: VehicleDoor | T
  ): VehicleDoorState | V {
    // TODO implement
    return null;
  }
  ...
  public getPartDamageLevel<T extends number, V extends number>(
    partId: VehiclePart | T
  ): VehiclePartDamage | V {
    // TODO implement
    return null;
  }
   ...
   */
  public setBumperDamageLevel(
    bumperId: VehicleBumper,
    level: VehicleBumperDamage
  ): void;

  public setBumperDamageLevel<T extends number, V extends number>(
    bumperId: VehicleBumper | T,
    level: VehicleBumperDamage
  ): void {
    // TODO implement
  ...
  public setDoorState<T extends number, V extends number>(
    doorId: VehicleDoor | T,
  ...
  public setMod<T extends number>(
  ...
  public setPartBulletHoles<T extends number>(
    partId: VehiclePart | T,
    count: number
  ): void {
    // TODO implement
   ...
   * @param level The damage level.
   */
  public setPartDamageLevel(
    partId: VehiclePart,
    level: VehiclePartDamage
  ): void;

  public setPartDamageLevel<T extends number, V extends number>(
    partId: VehiclePart | T,
    level: VehiclePartDamage
  ): void {
    // TODO implement
  ...
  public setMeta<K extends string>(
    key: K,
    value: InterfaceValueByKey<ICustomVehicleMeta, K, unknown, void>
  ): void;
  public setMeta<K extends ExtractStringKeys<ICustomVehicleMeta>>(
    key: K,
  ...
  public setMeta<V extends any, K extends string = string>(
    key: K,
    value: InterfaceValueByKey<ICustomVehicleMeta, K, V, void>
  ): void;

  public setMeta<
    K extends string | ExtractStringKeys<ICustomVehicleMeta>,
    V extends any
  >(
    key: K | MetaValues<ICustomVehicleMeta>,
    value:
      | InterfaceValueByKey<ICustomVehicleMeta, K, unknown, void>
      | ICustomVehicleMeta[K]
      | InterfaceValueByKey<ICustomVehicleMeta, K, V, void>
  ): void {
    // TODO implement
  }
  public deleteMeta(key: string): void;

  public deleteMeta<K extends ExtractStringKeys<ICustomVehicleMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  public getMeta<K extends string>(key: Exclude<K, never>): unknown;
  public getMeta<K extends ExtractStringKeys<ICustomVehicleMeta>>(
    key: K
  ): ICustomVehicleMeta[K];
  /** @deprecated See {@link ICustomVehicleMeta} */
  ...
  public getMeta<
    K extends string | ExtractStringKeys<ICustomVehicleMeta>,
    V extends any
  >(key: Exclude<K, never> | string): unknown | ICustomVehicleMeta[K] | V {
    // TODO implement
    return null;
  }
  public hasMeta(key: string): boolean;

  public hasMeta<K extends ExtractStringKeys<ICustomVehicleMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public setSyncedMeta<K extends string>(
    key: K,
    value: InterfaceValueByKey<ICustomVehicleSyncedMeta, K, unknown, void>
  ): void;
  public setSyncedMeta<K extends ExtractStringKeys<ICustomVehicleSyncedMeta>>(
    key: K,
    value: ICustomVehicleSyncedMeta[K]
  ): void;
  /** @deprecated See {@link "alt-shared".ICustomVehicleSyncedMeta} */
  public setSyncedMeta<V extends any, K extends string = string>(
    key: K,
    value: InterfaceValueByKey<ICustomVehicleSyncedMeta, K, V, void>
  ): void;

  public setSyncedMeta<
    K extends string | ExtractStringKeys<ICustomVehicleSyncedMeta>,
    V extends any
  >(
    key: K | MetaValues<ICustomVehicleSyncedMeta>,
    value:
      | InterfaceValueByKey<ICustomVehicleSyncedMeta, K, unknown, void>
      | ICustomVehicleSyncedMeta[K]
      | InterfaceValueByKey<ICustomVehicleSyncedMeta, K, V, void>
  ): void {
    // TODO implement
  }
  public deleteSyncedMeta(key: string): void;
  ...
  public deleteSyncedMeta<
    K extends ExtractStringKeys<ICustomVehicleSyncedMeta>
  >(key: string | K): void {
    // TODO implement
  }
  public getSyncedMeta<K extends string>(key: Exclude<K, never>): unknown;
  public getSyncedMeta<K extends ExtractStringKeys<ICustomVehicleSyncedMeta>>(
    key: K
  ): ICustomVehicleSyncedMeta[K];
  /** @deprecated See {@link "alt-shared".ICustomVehicleSyncedMeta} */
  ...
  >(
    key: Exclude<K, never> | string
  ): unknown | ICustomVehicleSyncedMeta[K] | V {
    // TODO implement
    return null;
  }
  public hasSyncedMeta(key: string): boolean;

  public hasSyncedMeta<K extends ExtractStringKeys<ICustomVehicleSyncedMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public setStreamSyncedMeta<K extends string>(
    key: K,
    value: InterfaceValueByKey<ICustomVehicleStreamSyncedMeta, K, unknown, void>
  ): void;
  public setStreamSyncedMeta<
    K extends ExtractStringKeys<ICustomVehicleStreamSyncedMeta>
  >(key: K, value: ICustomVehicleStreamSyncedMeta[K]): void;
  /** @deprecated See {@link "alt-shared".ICustomVehicleStreamSyncedMeta} */
  public setStreamSyncedMeta<V extends any, K extends string = string>(
    key: K,
    value: InterfaceValueByKey<ICustomVehicleStreamSyncedMeta, K, V, void>
  ): void;

  public setStreamSyncedMeta<
    K extends string | ExtractStringKeys<ICustomVehicleStreamSyncedMeta>,
    V extends any
  >(
    key: K | MetaValues<ICustomVehicleStreamSyncedMeta>,
    value:
      | InterfaceValueByKey<ICustomVehicleStreamSyncedMeta, K, unknown, void>
      | ICustomVehicleStreamSyncedMeta[K]
      | InterfaceValueByKey<ICustomVehicleStreamSyncedMeta, K, V, void>
  ): void {
    // TODO implement
  }
  public deleteStreamSyncedMeta(key: string): void;
  ...
  public getStreamSyncedMeta<
    K extends ExtractStringKeys<ICustomVehicleStreamSyncedMeta>
  >(key: K): ICustomVehicleStreamSyncedMeta[K];
  /** @deprecated See {@link "alt-shared".ICustomVehicleStreamSyncedMeta} */
  ...
  >(
    key: Exclude<K, never> | string
  ): unknown | ICustomVehicleStreamSyncedMeta[K] | V {
    // TODO implement
    return null;
  }
  public hasStreamSyncedMeta(key: string): boolean;
...
export class Blip extends WorldObject {
  ...
  public color:
    ...
    | BlipColor.Violet
    | BlipColor.Pink
    | BlipColor.LightOrange
    | BlipColor.LightBrown
    | BlipColor.LightGreen
    | BlipColor.LightBlue
    | BlipColor.LightPurple
    | BlipColor.DarkPurple
    | BlipColor.Cyan
    | BlipColor.LightYellow
    | BlipColor.Organe
    | BlipColor.GraniteGreen
    | BlipColor.DarkBrown
    | BlipColor.LightGray
    | BlipColor.LightPink
    | BlipColor.LemonGreen
    | BlipColor.ForestGreen
    | BlipColor.ElectricBlue
    | BlipColor.BrightPurple
    | BlipColor.DarkYellow
    | BlipColor.PinkRed
    | BlipColor.Orange
    | BlipColor.BrilliantRose
    | BlipColor.Salmon
    | BlipColor.DarkGreen
    | BlipColor.BlizzardBlue
    | BlipColor.OracleBlue
    | BlipColor.Silver
    | BlipColor.MulberryPink
    | BlipColor.AltoGray
    | BlipColor.JellyBeanBlue
    | BlipColor.DarkOrange
    | BlipColor.Mamba
    | BlipColor.White
    | BlipColor.Red
    | BlipColor.Green
  ...
  public deleteMeta<K extends ExtractStringKeys<ICustomBlipMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  ...
  public hasMeta<K extends ExtractStringKeys<ICustomBlipMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public getMeta<K extends string>(key: Exclude<K, never>): unknown;
  public getMeta<K extends ExtractStringKeys<ICustomBlipMeta>>(
    key: K
  ): ICustomBlipMeta[K];
  /** @deprecated See {@link ICustomBlipMeta} */

  public getMeta<
    K extends string | ExtractStringKeys<ICustomBlipMeta>,
    V extends any
  >(key: Exclude<K, never> | string): unknown | ICustomBlipMeta[K] | V {
    // TODO implement
    return null;
  }
  public setMeta<K extends string>(
    key: K,
    value: InterfaceValueByKey<ICustomBlipMeta, K, unknown, void>
  ): void;
  public setMeta<K extends ExtractStringKeys<ICustomBlipMeta>>(
    key: K,
  ...
  public setMeta<V extends any, K extends string = string>(
    key: K,
    value: InterfaceValueByKey<ICustomBlipMeta, K, V, void>
  ): void;
  ...
  public setMeta<
    ...
    V extends any
  >(
    key: K | MetaValues<ICustomBlipMeta>,
    value:
...
export class Colshape extends WorldObject {
  ...
  public deleteMeta<K extends ExtractStringKeys<ICustomColshapeMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  ...
  public hasMeta<K extends ExtractStringKeys<ICustomColshapeMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public getMeta<K extends string>(key: Exclude<K, never>): unknown;
  public getMeta<K extends ExtractStringKeys<ICustomColshapeMeta>>(
    key: K
  ): ICustomColshapeMeta[K];
  /** @deprecated See {@link ICustomColshapeMeta} */

  public getMeta<
    K extends string | ExtractStringKeys<ICustomColshapeMeta>,
    V extends any
  >(key: Exclude<K, never> | string): unknown | ICustomColshapeMeta[K] | V {
    // TODO implement
    return null;
  }
  public setMeta<K extends string>(
    key: K,
    value: InterfaceValueByKey<ICustomColshapeMeta, K, unknown, void>
  ): void;
  public setMeta<K extends ExtractStringKeys<ICustomColshapeMeta>>(
    key: K,
  ...
  public setMeta<V extends any, K extends string = string>(
    key: K,
    value: InterfaceValueByKey<ICustomColshapeMeta, K, V, void>
  ): void;
  ...
  public setMeta<
    ...
    V extends any
  >(
    key: K | MetaValues<ICustomColshapeMeta>,
    value:
      | InterfaceValueByKey<ICustomColshapeMeta, K, unknown, void>
      | ICustomColshapeMeta[K]
      | InterfaceValueByKey<ICustomColshapeMeta, K, V, void>
  ): void {
    // TODO implement
  }
}
...
export class Checkpoint extends Colshape {
   ...
   */
  public readonly streamingDistance: number;
  public declare static readonly all: readonly Checkpoint[];
  public static readonly count: number;
  public visible: boolean;
  /**
  ...
  public deleteMeta<K extends ExtractStringKeys<ICustomCheckpointMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  ...
  public hasMeta<K extends ExtractStringKeys<ICustomCheckpointMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public getMeta<K extends string | ExtractStringKeys<ICustomCheckpointMeta>>(
    key: Exclude<K, never>
  ): unknown | ICustomCheckpointMeta[K] {
    // TODO implement
    return null;
  }
  public setMeta<K extends string>(
    key: K,
    value: InterfaceValueByKey<ICustomCheckpointMeta, K, unknown, void>
  ): void;
  public setMeta<K extends ExtractStringKeys<ICustomCheckpointMeta>>(
    key: K,
    value: ICustomCheckpointMeta[K]
  ): void;

  public setMeta<K extends string | ExtractStringKeys<ICustomCheckpointMeta>>(
    key: K | MetaValues<ICustomCheckpointMeta>,
    value:
      | InterfaceValueByKey<ICustomCheckpointMeta, K, unknown, void>
      | ICustomCheckpointMeta[K]
  ): void {
    // TODO implement
  }
  public setStreamSyncedMeta<K extends string>(
  ...
  public setStreamSyncedMeta<
    K extends ExtractStringKeys<ICustomCheckpointStreamSyncedMeta>
  >(key: K, value: ICustomCheckpointStreamSyncedMeta[K]): void;

  public setStreamSyncedMeta<
    K extends string | ExtractStringKeys<ICustomCheckpointStreamSyncedMeta>
  >(
    key: K | MetaValues<ICustomCheckpointStreamSyncedMeta>,
    value:
      | InterfaceValueByKey<ICustomCheckpointStreamSyncedMeta, K, unknown, void>
      | ICustomCheckpointStreamSyncedMeta[K]
  ): void {
    // TODO implement
  }
  public deleteStreamSyncedMeta(key: string): void;
  ...
  public getStreamSyncedMeta<
    K extends string | ExtractStringKeys<ICustomCheckpointStreamSyncedMeta>
  >(key: Exclude<K, never>): unknown | ICustomCheckpointStreamSyncedMeta[K] {
    // TODO implement
    return null;
  }
  public hasStreamSyncedMeta(key: string): boolean;
...
export class VoiceChannel extends BaseObject {
  ...
  public deleteMeta<K extends ExtractStringKeys<ICustomVoiceChannelMeta>>(
    key: string | K
  ): void {
    // TODO implement
  }
  ...
  public hasMeta<K extends ExtractStringKeys<ICustomVoiceChannelMeta>>(
    key: string | K
  ): boolean {
    // TODO implement
    return false;
  ...
  public getMeta<K extends string>(key: Exclude<K, never>): unknown;
  public getMeta<K extends ExtractStringKeys<ICustomVoiceChannelMeta>>(
    key: K
  ): ICustomVoiceChannelMeta[K];
  /** @deprecated See {@link ICustomVoiceChannelMeta} */

  public getMeta<
    K extends string | ExtractStringKeys<ICustomVoiceChannelMeta>,
    V extends any
  >(key: Exclude<K, never> | string): unknown | ICustomVoiceChannelMeta[K] | V {
    // TODO implement
    return null;
  }
  public setMeta<K extends string>(
    key: K,
    value: InterfaceValueByKey<ICustomVoiceChannelMeta, K, unknown, void>
  ): void;
  public setMeta<K extends ExtractStringKeys<ICustomVoiceChannelMeta>>(
    key: K,
  ...
  public setMeta<V extends any, K extends string = string>(
    key: K,
    value: InterfaceValueByKey<ICustomVoiceChannelMeta, K, V, void>
  ): void;
  ...
  public setMeta<
    ...
    V extends any
  >(
    key: K | MetaValues<ICustomVoiceChannelMeta>,
    value:
      | InterfaceValueByKey<ICustomVoiceChannelMeta, K, unknown, void>
      | ICustomVoiceChannelMeta[K]
      | InterfaceValueByKey<ICustomVoiceChannelMeta, K, V, void>
  ): void {
    // TODO implement
  }
}
...
export class Resource extends Resource_1 {
  ...
  public declare static readonly all: readonly Resource[];
  public declare static readonly current: Resource;
...
export class Ped extends Entity {
  ...
  public declare static readonly all: readonly Ped[];
  public static readonly count: number;
  public currentWeapon: number;
  public health: number;
  public maxHealth: number;
...
export class ServerObject extends Entity {
  ...
  public declare static readonly all: readonly Object[];
  public static readonly count: number;
