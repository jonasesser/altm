...
export interface ICustomPlayerStreamSyncedMeta
  extends ICustomEntityStreamSyncedMeta {}
/**
...
export function deleteMeta<K extends ExtractStringKeys<ICustomGlobalMeta>>(
  key: K
): void;
export function deleteMeta<K extends ExtractStringKeys<ICustomGlobalMeta>>(
  key: K
...
export function getMeta<K extends string>(
  key: Exclude<K, keyof ICustomGlobalMeta>
): unknown;
export function getMeta<K extends ExtractStringKeys<ICustomGlobalMeta>>(
  key: K
): ICustomGlobalMeta[K] | undefined;
...
export function hasMeta<K extends ExtractStringKeys<ICustomGlobalMeta>>(
  key: K
): boolean;
export function hasMeta<K extends ExtractStringKeys<ICustomGlobalMeta>>(
  key: K
...
export function setMeta<K extends string>(
  key: K,
  value: InterfaceValueByKey<ICustomGlobalMeta, K>
): void;
export function setMeta<K extends ExtractStringKeys<ICustomGlobalMeta>>(
  key: K,
...
export function setMeta<V extends any, K extends string = string>(
  key: K,
  value: InterfaceValueByKey<ICustomGlobalMeta, K, V, void>
): void {
  // TODO Implement
}

export function getSyncedMeta<K extends string>(
  key: Exclude<K, keyof ICustomGlobalSyncedMeta>
): unknown;
export function getSyncedMeta<
  K extends ExtractStringKeys<ICustomGlobalSyncedMeta>
>(key: K): ICustomGlobalSyncedMeta[K] | undefined;
...
export class Vector3 {
  ...
  public add(
    x: number | [number, number, number] | IVector3,
    y: number,
    z: number
  ): Vector3 {
    // TODO implement
...
export class File {
  ...
  public static read(
    filename: string,
    encoding: FileEncoding.Utf8 | FileEncoding.Utf16 | "utf-8" | "utf-16"
  ): string;
  /**
   * Reads content of the file.
   *
...
export class BaseObject {
  ...
  public getMeta<K extends string>(
    key: K
  ): K extends keyof ICustomBaseObjectMeta
    ? ICustomBaseObjectMeta[K]
    : unknown {
    // TODO implement
    return null as any;
  ...
  >(key: K): ICustomBaseObjectSyncedMeta[K];
  ...
  ): unknown | ICustomBaseObjectSyncedMeta[K] | V {
    // TODO implement
    return null;
  }
  /**
