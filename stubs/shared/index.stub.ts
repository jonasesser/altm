...
export function deleteMeta<K extends ExtractStringKeys<ICustomGlobalMeta>>(xOrValue: string | K): void {
    // TODO Implement
}
/**
...
export function getMeta<K extends ExtractStringKeys<ICustomGlobalMeta>>(xOrValue: Exclude<K, never> | K): ICustomGlobalMeta[K] {
    // TODO Implement
    return null;
}
...
export function hasMeta<K extends ExtractStringKeys<ICustomGlobalMeta>>(xOrValue: string | K): boolean {
    // TODO Implement
    return false;
}
/**
...
export function setMeta<K extends ExtractStringKeys<ICustomGlobalMeta>>(xOrValue: K, y?: InterfaceValueByKey<ICustomGlobalMeta, K, unknown, void> | ICustomGlobalMeta[K]): void {
    // TODO Implement
}
// Deprecated Overloads:
/** @deprecated See {@link ICustomGlobalMeta} */
...
export function getSyncedMeta<K extends ExtractStringKeys<ICustomGlobalSyncedMeta>>(xOrValue: Exclude<K, never> | K): ICustomGlobalSyncedMeta[K] {
    // TODO Implement
    return null;
}
// Deprecated Overloads:
...
export function hasSyncedMeta<K extends ExtractStringKeys<ICustomGlobalSyncedMeta>>(xOrValue: string | K): boolean {
    // TODO Implement
    return false;
}
/**
...
export function time(xOrValue?: string): void {
    // TODO Implement
}
export function timeEnd(timerName: string): void;
export function timeEnd(): void;
export function timeEnd(xOrValue?: string): void {
    // TODO Implement
}
...
export class RGBA {
    ...
    constructor(r: number | [number, number, number, number?] | { r: number; g: number; b: number; a?: number }, g?: number, b?: number, a?: number) {
        if (Array.isArray(r)) {
            [this.r, this.g, this.b, this.a] = r;
        } else if (typeof r === 'object') {
            ({ r: this.r, g: this.g, b: this.b, a = 1 } = r);
        } else {
            this.r = r;
            this.g = g ?? 0;
            this.b = b ?? 0;
        ...
        this.a = this.a ?? 1; // Ensure alpha defaults to 1
    }
...
export class File {
     ...
     */
    public static read(filename: string, encoding?: FileEncoding.Utf8 | FileEncoding.Utf16 | 'utf-8' | 'utf-16'): string | ArrayBuffer | null {
        // Default return value if encoding is not provided
        return null;
    }
}
export class BaseObject {
    ...
    public setMeta<K extends string | ExtractStringKeys<ICustomBaseObjectMeta>, V extends any>(values: MetaValues<ICustomBaseObjectMeta>, value: InterfaceValueByKey<ICustomBaseObjectMeta, K, V, void>): void {
        // TODO implement
    }
    /**
     * Gets a value using the specified key.
    ...
    /** @deprecated See {@link "alt-.ICustomBaseObjectSyncedMeta} */
